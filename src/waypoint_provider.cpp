...
//: nh_(n)
  ...
  void WaypointProvider::generateWaypointMarkers(const waypoint_msgs::WaypointList& wps,
  ...
  void WaypointProvider::generateTrajectoryMarkers(const waypoint_msgs::TrajectoryList& trajs,
...
int main(int argc, char** argv)
{
  ...
  if(!yp.loadWaypointsAndTrajectoriesFromYaml(filename, wps, trajs))
  {
